...
<div class="row" data-aos="fade-up" data-aos-delay="200">
  <div class="col-lg-12 d-flex justify-content-center">
    <ul id="portfolio-flters">
      ...
      <li data-filter=".filter-card" id="pantalon" class="filter" onclick="change('pantalon')" style="color: black;"> <a href="{{ route('pantalonHomme', ['selected' => 'pantalon']) }}" class="filter-link" style="color: black;">Pantalon</a></li>
    </ul>
  </div>
</div>
<div class="homme">
